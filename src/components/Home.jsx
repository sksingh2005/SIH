    ...
    <div className="  w-full overflow-hidden">
      ...
      <div className={`fixed top-0 left-0 h-full z-50 bg-gray-500 p-4 transform transition-transform duration-300 md:hidden ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <ul className="space-y-2 mt-12">
          ...
          <li><a href="#services" className="block py-2 px-4 text-gray-900 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 rounded-lg text-center">Services</a></li>
        </ul>
      </div>
